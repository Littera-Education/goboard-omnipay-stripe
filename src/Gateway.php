...
class Gateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('\Omnipay\Stripe\Message\FetchAccountRequest', $parameters);
    }

    public function createAccount(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Stripe\Message\CreateAccountRequest', $parameters);
    }

    public function updateAccount(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Stripe\Message\UpdateAccountRequest', $parameters);
    }

    public function updateCapability(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Stripe\Message\UpdateCapabilityRequest', $parameters);
    }

    public function createPayout(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Stripe\Message\PayoutRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Omnipay\Stripe\Message\FetchTransferRequest', $parameters);
    }
}
